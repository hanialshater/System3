...
رُتبت المراجع بحسب الفصول، وبصورة تقارب ترتيب ظهورها في النص. يذكر المتن العمل باختصار، ويحمل هذا الملحق بيانات الاستشهاد الكاملة والرابط. آخر تحقق من مصادر الويب المؤرخة بين 2025 و2026 كان في أغسطس 2026.
...
- Christopher G. Langton, "Computation at the edge of chaos: Phase transitions and emergent computation," *Physica D* 42 (1990), 12–37 — أحد الأصول المبكرة لعبارة "edge of chaos" التي يحبها الفصل ويرتاب منها في الوقت نفسه. <https://doi.org/10.1016/0167-2789%2890%2990064-V>

## الفصل الثاني — دوامة الخوارزميات

- Alexander Novikov et al., "AlphaEvolve: A coding agent for scientific and algorithmic discovery" (Google DeepMind, 2025) — مصدر القيمة المرجعية 2.635 لمسألة الدوائر الست والعشرين. <https://arxiv.org/abs/2506.13131>
...
- Claude Code (Anthropic) وAider — وكيلا البرمجة المستخدمان في تجارب الفصل. <https://code.claude.com> · <https://aider.chat>
...
- Jack Clark and Dario Amodei, "Faulty reward functions in the wild" (OpenAI, 2016) — تجربة قارب CoastRunners. <https://openai.com/index/faulty-reward-functions/>
...
- نماذج الشرح التي يطمح الفصل إلى الاقتراب من جودتها: *Distill* (<https://distill.pub>)، وشروحات Jay Alammar البصرية (<https://jalammar.github.io>)، و3Blue1Brown (<https://www.3blue1brown.com>).
...
- Live-SWE-agent — العمل الوكيلي الذي وقع فيه حادث محلل ملفات MARC: وكلاء يبنون أدوات جديدة أثناء التشغيل عندما تعجز الأدوات القائمة عن كشف البيانات.
- SWE-bench Verified (OpenAI, 2024) — الجزء الذي تحقّق منه البشر من SWE-bench، والمستخدم في مقارنة epistemic-swe. <https://openai.com/index/introducing-swe-bench-verified/>
- mini-swe-agent (SWE-agent project) — الوكيل المرجعي في تجربة الفصل. <https://github.com/SWE-agent/mini-swe-agent>
- Astropy — المستودع الذي جاءت منه مسائل التقييم العشر. <https://github.com/astropy/astropy>

## الفصل الخامس — مجتمع الوكلاء

- Nicholas Carlini, "Building a C compiler with a team of parallel Claudes" (Anthropic engineering blog, 2026) — مشروع المترجم الذي بناه ستة عشر Claude ويفتتح به الفصل. <https://www.anthropic.com/engineering/building-c-compiler>
- Riichiro Inagaki and Boichi, *Dr. Stone* (2017–2022) — حيلة Senku.
...
- Steven Shapin and Simon Schaffer, *Leviathan and the Air-Pump: Hobbes, Boyle, and the Experimental Life* (Princeton University Press, 1985) — القراءة التي يستند إليها الفصل في مشكلة تكرار تجارب Boyle.
...
- Andrej Karpathy, "Software 2.0" (2017) — <https://karpathy.medium.com/software-2-0-a64152b37c35> — و"Software Is Changing (Again)" (talk, 2025)، مصدر تسمية "Software 3.0."
...
- Andrej Karpathy, `autoresearch` (2026) — وكيل يجري تجارب مستقلة على إعداد صغير لتدريب نموذج لغوي ضمن ميزانية ثابتة. <https://github.com/karpathy/autoresearch>
- Meta AI, "HyperAgents" (2026) — يجمع تعديل المهمة وتعديل الآليات الفوقية في برنامج واحد قابل للتحرير. <https://ai.meta.com/research/publications/hyperagents/>
...
- Jacques Derrida — التفكيك الذي يتعمد الفصل أن يكون ظالمًا معه؛ انظر *Of Grammatology* (1967).

## الفصل الثالث عشر — النبوءة

- The Wachowskis, *The Matrix* (1999). أما الضرائب فمن عندنا.
